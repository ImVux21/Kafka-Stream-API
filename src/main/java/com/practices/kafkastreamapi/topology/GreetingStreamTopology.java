...
import com.practices.kafkastreamapi.serdes.JsonSerde;
...
public class GreetingStreamTopology {
    ...
    @Autowired
    public GreetingStreamTopology(ObjectMapper objectMapper) {
    ...
    */
    ...
    public void process(StreamsBuilder streamsBuilder) {
        ...
        JsonSerde<Greeting> greetingJsonSerde = new JsonSerde<>(objectMapper, Greeting.class);
